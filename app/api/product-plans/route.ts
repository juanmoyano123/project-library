...
// GET /api/product-plans?projectId=xxx - Get product plans for a project
...
// POST /api/product-plans - Create a new product plan
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(productPlan, { status: 201 });
  } catch (error) {
